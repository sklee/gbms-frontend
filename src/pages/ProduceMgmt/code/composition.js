...
const produceCompList = observer(({tab}) => {
        ...
        grid.draggedRow.addHandler(function (s, e) {
            ...
            sort_arr.sort((a, b) => {
                if (a.use_yn === "Y" && b.use_yn === "N") {
                  ...
                  return a.ordnum - b.ordnum; // id를 오름차순으로 정렬
                }
            });
    ...
    const rowAdd=(e)=>{    
        if(e === true){ //행추가일때
            ...
            state.currentEditItem = {id:state.addCnt, name : '',ordnum : 1, use_yn: '', addCode : ''};
        ...
        <Wrapper>
            ...
            <Row className="gridWrap">       
                ...
                >
                    ...
                    <FlexGridColumn binding="name" header="상품 구성 방식" width={'*'} minWidth={200} align="left" />
...
export default produceCompList;

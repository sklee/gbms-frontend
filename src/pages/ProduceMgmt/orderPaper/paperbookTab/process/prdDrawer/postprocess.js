...
const PostprocessDrawer = ({ commonStore, viewVisible, visibleClose, setProcessingDrawerData }) => {
            ...
            <Row className="gridWrap">
                <Table 
                    ...
                    onRow       = {(record) => ({
                        onClick : (event) => { 
                            visibleClose()
                            setProcessingDrawerData(record)
                        }
                    })}
                />
            </Row>
...
export default inject('commonStore')(observer(PostprocessDrawer))
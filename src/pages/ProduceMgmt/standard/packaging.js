...
const packagingSimList = observer(({tab}) => {
            ...
            >
                <Row gutter={10} className="table">
                    ...
                    <Col xs={24} lg={16} className="label">
                        <Input type="number" min="0" autoComplete="off" value={stateData.apply_price} onChange={handlePriceInput('apply_price')} />
                    </Col>
                </Row>
            </Modal>
...
export default packagingSimList;

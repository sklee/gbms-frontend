...
const postProcessSimList = observer(({tab}) => {
    const { commonStore } = useStore();
    const { Option } = Select;
    const stateData = useLocalStore(() => ({produce_process_id:"", paper_standard_id:"", apply_date :"", apply_price :""}));
    const { confirm } = Modal;

    const state = useLocalStore(() => ({
        type : 'simulation-processing',
        list: [],
        selPrice:'',
        historyList:[],
        data: [],
    ...
    const initFilter = (filter) => {
        filter.filterColumns = ["produce_process", "paper_standard", "produce_process_unit", "avg_price", "apply_price", "apply_date", "memo", "buttons"];
    };
        ...
        grid.addEventListener(grid.hostElement, 'click', (e) => {
            if (e.target instanceof HTMLButtonElement) {
                ...
                if(e.target.classList.contains('btn_modify')){
                    ...
                    state.selPrice = item.apply_price;
    ...
    const modalOpen = (obj,item) => {
        ...
        if(obj == 'modify'){
            ...
            stateData.paper_standard_id = item.paper_standard_id;
    ...
    const modifyOk= (obj,e)=> {
        if(obj == 'modify'){
            ...
            temp_prices['paper_standard_id'] = stateData.paper_standard_id;
            temp_prices['prices']={
        ...
        <Wrapper>
            ...
            <Row className="gridWrap">       
                ...
                >
                    ...
                    <FlexGridColumn binding="produce_process_unit" header="단가 기준" width={120} />
                    <FlexGridColumn binding="avg_price" header="평균 단가" width={120} align="right" />
                    <FlexGridColumn binding="apply_price" header="적용 단가" width={120} align="right" />
                    <FlexGridColumn binding="apply_date" header="적용일" width={150} />
                    <FlexGridColumn binding="memo" header="참고사항" width={180} />
...
export default postProcessSimList;

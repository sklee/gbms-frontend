...
const bindingAddList = observer(({tab}) => {
    ...
    const getProcess = useCallback(async () =>{
        ...
        state.produce_process = result.data.data.filter(e => e.produce_process_code_id ? e.produce_process_code_id=='5' : false );

    ...
    useEffect(() => {       
        ...
        if(data['idx_'+dataInfo.id.id]!==undefined){
            ...
            if(idata !== null && idata !== undefined){
                ...
                stateData.contract_files = []; //파일 재배열
                idata.contract_files.forEach(e => {
                    ...
                    stateData.contract_files = [...stateData.contract_files, {id:e.id, file_name: e.file_name, file_path: e.file_path, use_yn:'Y'}]
                });
                setFileList(state.selectedFile);

                stateData.etc_files = []; //파일 재배열
                idata.etc_files.forEach(e => {
                    ...
                    stateData.etc_files = [...stateData.etc_files, {id:e.id, file_name: e.file_name, file_path: e.file_path, use_yn:'Y'}]
                });
                ...
                stateData.contract_files = []; //파일 재배열
                if(fileData && fileData.contract_files){
                ...
                stateData.etc_files = []; //파일 재배열
                if(fileData && fileData.etc_files){
        ...
        stateData.copyright_fee_deducting = stateData.copyright_fee_deducting ?? "1";

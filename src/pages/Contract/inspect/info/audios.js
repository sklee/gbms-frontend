        ...
        <Wrapper>
            ...
            {state.states ==='insert'                     
                ...
                <Row gutter={10} className="table marginTop">
                    ...
                    <Col xs={19} lg={19}>
                        영업 및 판매관리 비용으로 매출의 &nbsp;
                        <Input type="number" min="0" name="fixed_royalty1" value={stateData.fixed_royalty1} onChange={handleChangeInput('fixed_royalty1')} autoComplete="off" style={{width:'8%'}}/>
                        %를 공제하고 나머지 금액의 &nbsp;
                        <Input type="number" min="0" name="fixed_royalty2" value={stateData.fixed_royalty2} onChange={handleChangeInput('fixed_royalty2')} autoComplete="off" style={{width:'8%'}}/>%
                    </Col>
                    <Col xs={5} lg={5} className="label">

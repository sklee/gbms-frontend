            ...
            {stateData.sel_type !=='I'                     
                ...
                <Wrapper>
                    <Row gutter={10} className="table marginTop">
                        <div className="table_title">2차 저작권</div>
                        ...
                        <Col xs={19} lg={19}>
                            영업 및 판매관리 비용으로 매출의 &nbsp;
                            <Input type="number" min="0" name="deduction_rate" value={stateData.deduction_rate} onChange={handleChangeInput('deduction_rate')} autoComplete="off" style={{width:'10%'}}/>%를 공제하고,
                             나머지 금액의 &nbsp;
                            <Input type="number" min="0" name="payment_rate" value={stateData.payment_rate} onChange={handleChangeInput('payment_rate')} autoComplete="off" style={{width:'10%'}}/>
                            %를 저작권료로 지급
                        </Col>
                        <Col xs={5} lg={5} className="label">
                        ...
                        <Radio.Group
                            ...
                            <div>
                            순수입의 &nbsp;
                            <Input type="number" min="0" name="company_use_rate" value={stateData.company_use_rate} onChange={handleChangeInput('company_use_rate')} autoComplete="off" style={{width:'8%'}}/>
                            %를 저작권료로 지급
                            </div>
                            }
                        </Col>

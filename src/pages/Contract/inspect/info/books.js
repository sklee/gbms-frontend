    ...
    useEffect(() => {       
        ...
        if(data !== null && data !== undefined){
            if(Object.keys(data).length > 0){
                var temp_type = Object.keys(type==='overseas-check'?DEF_STATE_OS:DEF_STATE);
            ...
            {state.states ==='insert'                     
                ...
                <Row gutter={10} className="table marginTop">
                    ...
                    <Col xs={19} lg={19}>
                        ...
                        <Input type="number" min="0" name="extension_year" value={stateData.extension_year} onChange={handleChangeInput('extension_year')} autoComplete="off" style={{width:'8%'}}/>년 단위로 자동 연장
                        (자동 연장 없으면 0으로 입력)
                    </Col>
                    <Col xs={5} lg={5} className="label">
                    ...
                    <Col xs={19} lg={19}>
                        <Input type="text" name="prepaid_royalty" value={stateData.prepaid_royalty.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} onChange={handleChangeInput('prepaid_royalty')} autoComplete="off" style={{width:'20%'}}/>원(없으면 0으로 입력)을 &nbsp;
                    ...
                    <Col xs={19} lg={19}>
                        ...
                        <Space>
                            ...
                            <Input type="text" name="qty" value={item.qty?item.qty.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","):''} onChange={handleChangeRoyalty(index,'qty')} autoComplete="off" onBlur={handleBlurRoyalty(index)}/>부 또는 
                    ...
                    {stateData.first_royalty_yn == 'Y' && 
                    <Col xs={19} lg={19}>
                        <Input type="number" min="0" name="exemption_royalty_qty" value={stateData.exemption_royalty_qty} onChange={handleChangeInput('exemption_royalty_qty')} autoComplete="off" style={{width:'10%'}}/>부(없으면 0으로 입력)
                    </Col>
                    }
                    <Col xs={5} lg={5} className="label">
                    ...
                    <Col xs={19} lg={19}>
                        기준 공급률 
                        <Input type="number" min="0" name="special_royalty1" value={stateData.special_royalty1} onChange={handleChangeInput('special_royalty1')} autoComplete="off" style={{width:'10%'}}/>
                        % 이하이며, 정가의 &nbsp;
                        <Input type="number" min="0" name="special_royalty2" value={stateData.special_royalty2} onChange={handleChangeInput('special_royalty2')} autoComplete="off" style={{width:'10%'}}/>

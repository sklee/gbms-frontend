...
import RenewAudios from './audiosRenew';
...
const contractsDrawer = observer(({type,selType,states,copyId,data,audiosVal,drawerClass,drawerChk}) => {
        ...
        <Wrapper>
            {/* ================================================= 국내 / 해외 직계약  ========================================================== */}
                ...
                <Row gutter={10} className="table marginTop">
                    <div className="table_title">오디오북 계약 상태 : {state.status}</div>
                    ...
                    <Col xs={19} lg={19}>
                        영업 및 판매관리 비용으로 매출의 
                        {stateData.fixed_royalty1}%를 공제하고 나머지 금액의 
                        {stateData.fixed_royalty2}%
                    </Col>
                    <Col xs={5} lg={5} className="label">
                        대여/구독 가능 여부  
                    </Col>
                    <Col xs={19} lg={19}>
                        ...
                        {stateData.rental_type==='U'?'확인 안됨':null}
                    </Col>
                    {state.sel_type ==='K' &&
                    <Col xs={5} lg={5} className="label">
                        중개자 

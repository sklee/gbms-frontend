...
const contractsDrawer = observer(({type,selType,states,data,ebooksVal,init}) => {
    ...
    useEffect(() => {       
        ...
        if(init.range && init.range != 'ebook'){
        ...
        <Wrapper>
            ...
            {state.states ==='insert'                      
                ...
                <Row gutter={10} className="table marginUp">
                    ...
                    <Col xs={19} lg={19}>
                        <Input type="text" min="0" name="prepaid_royalty" value={stateData.prepaid_royalty.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} onChange={handleChangeInput('prepaid_royalty')} autoComplete="off" style={{width: 95, textAlign: 'right'}}/>원(없으면 0으로 입력)을&nbsp;
                    ...
                    <Col xs={19} lg={19}>
                        순수입의 <Input type="number" min="0" name="fixed_royalty" value={stateData.fixed_royalty} onChange={handleChangeInput('fixed_royalty')} autoComplete="off" style={{width: 55, textAlign: 'right'}}/>%
                    </Col>
                    <Col xs={5} lg={5} className="label">
            ...
            {state.states ==='insert'                     
                ...
                <Row gutter={10} className="table marginTop">
                    ...
                    <Col xs={19} lg={19}>
                        <Input type="text" name="data_cost" value={stateData.data_cost.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} onChange={handleChangeInput('data_cost')} autoComplete="off" style={{width: 90, textAlign: 'right'}}/>(USD)
                    </Col>
                    <Col xs={5} lg={5} className="label">
                        선불 저작권료(계약금) <span className="spanStar">*</span>
                    </Col>
                    <Col xs={19} lg={19}>
                        <Input type="text" name="prepaid_royalty" value={stateData.prepaid_royalty.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} onChange={handleChangeInput('prepaid_royalty')} autoComplete="off" style={{width: 90, textAlign: 'right'}}/>(USD)
                    </Col>
                    <Col xs={5} lg={5} className="label">
                        정기 저작권료 <span className="spanStar">*</span> 
                    </Col>

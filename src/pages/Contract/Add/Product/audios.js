...
const contractsDrawer = observer(({type,selType,states,data,audiosVal,init}) => {
    ...
    useEffect(() => {       
        ...
        if(init.range && init.range != 'audio'){
        ...
        <Wrapper>
            ...
            {state.states ==='insert'                     
                ...
                <Row gutter={10} className="table marginUp">
                    ...
                    <Col xs={19} lg={19}>
                        ...
                        <Radio value="0">계약 기간 내 매출에 대해서만 지급</Radio>
                    ...
                    <Col xs={19} lg={19}>
                        ...
                        <DatePicker value={stateData.prepaid_royalty_date} disabledDate={e=>handleCheckDate('prepaid_royalty_date',e)} name="prepaid_royalty_date" onChange={handleChangeInput('prepaid_royalty_date')}  />까지 지급
                    </Col>
                    <Col xs={5} lg={5} className="label">
                    ...
                    <Col xs={19} lg={19}>
                        영업 및 판매관리 비용으로 매출의&nbsp;
                        <Input type="number" min="0" name="fixed_royalty1" value={stateData.fixed_royalty1} onChange={handleChangeInput('fixed_royalty1')} autoComplete="off" style={{width: 55, textAlign: 'right'}}/>
                        %를 공제하고 나머지 금액의&nbsp;
                        <Input type="number" min="0" name="fixed_royalty2" value={stateData.fixed_royalty2} onChange={handleChangeInput('fixed_royalty2')} autoComplete="off" style={{width: 55, textAlign: 'right'}}/>%
                    </Col>
                    <Col xs={5} lg={5} className="label">
            ...
            {state.states ==='insert'                     
                ...
                {state.sel_type ==='I'                      
                    ?
                <Row gutter={10} className="table marginTop">
                    <div className="table_title">오디오북</div>
                    <Col xs={5} lg={5} className="label">
                            계약 기간 <span className="spanStar">*</span>
                        </Col>
                    <Col xs={19} lg={19}>

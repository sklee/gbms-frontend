...
const index = observer((props) => {
    ...
    const initFilter = (filter) => {
        filter.filterColumns = [ "type", "dismissalDay", "storage", "disposalSite", "note" ];
    };
        ...
        <>
            ...
            <Row className='gridWrap'>
                ...
                >
                    ...
                    <FlexGridColumn header='폐기일' binding='dismissalDay' width={120} />
                    <FlexGridColumn header='창고' binding='storage' width={200} />
                    <FlexGridColumn header='폐기처' binding='disposalSite' width={120}/>

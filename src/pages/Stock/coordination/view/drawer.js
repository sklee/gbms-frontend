        ...
        >   
            ...
            >
                {(props)=>(
                    <Form >
                        <Row className="table">
                            <FormikContainer type={'etc'} label={'회사'} name={'company'} labelWidth={3} perRow={2} />
                            ...
                            />
                            <FormikContainer type={'datepicker'} label={'조정일'} name={'adjustmentDate'} labelWidth={3} perRow={2} dateValue={formikFieldDefault.movementDate}/>

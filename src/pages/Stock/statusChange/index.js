...
const index = observer((props) => {
    ...
    const initFilter = (filter) => {
        filter.filterColumns = [ "company", "type", "changeDate", "storage", "amount", "note" ];
    };
        ...
        <>
            ...
            <Row className='gridWrap'>
                ...
                >
                    ...
                    <FlexGridColumn header='유형' binding='type' width={100} />
                    <FlexGridColumn header='변경일' binding='changeDate' width={100} />
                    <FlexGridColumn header='창고' binding='storage' width="*" minWidth={120} />
                    <FlexGridColumn header='수량' binding='amount' width={80} align='right'/>

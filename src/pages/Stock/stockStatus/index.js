                ...
                {(props)=>(
                    <Form >
                        <Row className="table search_table" ref={foldTable}>
                            ...
                            />
                            <FormikContainer type={'select'} labelWidth={3} perRow={2} label={'상품 그룹'} name={'prdGroup'} style={{width: '100%'}}
                                data = {{
                                    options : [{
                                        label : "1",
                                        value: 1
                            ...
                            />
                            <FormikContainer type={'etc'} labelWidth={3} perRow={2} label={'분석 조건'} name={'condition'}>
                                <>
                                    최근 
                                    <FormikInput type={'input'} name={'period'} dateValue={formikFieldDefault.period} style={{width: 50}}/>
                                    <FormikInput type={'select'} name={'unit'} dateValue={formikFieldDefault.unit} style={{width: 70, marginLeft: 10}}
                                        data = {{
                                            options : [{
                                                label : "일",
                                                value: 'day'

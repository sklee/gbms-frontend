...
import {Row, Col, Drawer, Button, Table, Typography, Input} from 'antd';
...
import Evidence from '../../Billing/Add/evidence';
...
const View = observer(({idx,  popoutClose, popoutChk ,viewVisible, onClose, drawerChk, viewData}) =>{
    ...
    const approvalDrawer = () => setApprovalVisible(true);
    const approvalClose = () => setApprovalVisible(false);

    //PDF파일(보이게 만들어놓음) 등록
    const [pdfVisible, setPdfVisible] = useState(false);
    const pdfClose = () => setPdfVisible(false);
        ...
        <Wrapper>
            ...
            >
                ...
                <Row gutter={[10, 10]} justify="center" style={{ marginTop: 20, marginBottom: 40 }}>
                    <Col>
                        <Button htmlType="button" onClick={approvalDrawer}>반려 / 승인</Button>
                    </Col>
                </Row>

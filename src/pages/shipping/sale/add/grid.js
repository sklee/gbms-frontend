                ...
                switch(col.binding){
                    ...
                    case 'work':
                        e.cell.innerHTML = `<div class="v-center">
                            <div>작업</div>
                            <select id="btnSel">
                                <option value="" disabled selected>추가</option>
    ...
    return(
        <>
            ...
            >
                ...
                <FlexGridColumn binding="genuine" header="정품" width={80} align="right" aggregate="Sum"/>
                ...
                <FlexGridColumn binding="supplyRate" header="공급률" width={80} align="right" />

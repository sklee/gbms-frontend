        ...
        >   
            ...
            >
                {(props)=>(
                    <Form >
                        <Row className="table">
                            <FormikContainer type={'datepicker'} labelWidth={3} perRow={2} label={'입고일'} name={'receivingDate'}/>
                            <FormikContainer type={'select'} labelWidth={3} perRow={2} label={'유형'} name={'type'} style={{width: '100%'}} 
                                data={{
                                    mode : 'tags',
                                    options : [
                                        {value:1, label:'1'}, 
                            ...
                            <FormikContainer type={'datepicker'} labelWidth={3} perRow={4} label={'처리일'} name={'processingDate'}/>
                            <FormikContainer type={'etc'} labelWidth={3} perRow={4} label={'처리자'} />
                            <FormikContainer type={'etc'} labelWidth={3} perRow={2} label={'회사'} />

                            <FormikContainer type={'etc'} labelWidth={3} perRow={2} label={'거래처(본점)'} />
                            <FormikContainer type={'etc'} labelWidth={3} perRow={2} label={'지점'} />

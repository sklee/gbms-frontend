    ...
    const initGrid = (grid) => {
        grid.formatItem.addHandler((s, e) => {
            if (e.panel == s.cells) {
                ...
                switch (col.binding) {
                    case 'Range_price':
                        let btn = '<button class="btnText title btn_price_modify">' + commaNum(item.price) + '</button>';
                        e.cell.innerHTML = btn;
                        break;               
                    case 'status':
                        let btn1 = '<button id="btnAdd" class="btnText blueTxt">추가</button>';
                        e.cell.innerHTML = btn1;
                        break;
                }                         
            }
        });
            ...
            >
                ...
                <Row id="gridWrap" className="gridWrap">
                    ...
                    >
                        ...
                        <FlexGridColumn header="단가 기준" binding="priceStandard" width={120}/>
                        <FlexGridColumn header="단가" binding="price" width={150} align="right"/>
                        <FlexGridColumn header="단가 적용일" binding="effective_at" width={150}/>
                        <FlexGridColumn header="참고사항" binding="ref" width="*" minWidth={150}/>

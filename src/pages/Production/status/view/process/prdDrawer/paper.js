...
const paper = observer(({ viewVisible, visibleClose }) => {
    React.useEffect(() => {
        ...
        <Wrapper>
            ...
            >
                ...
                <Row id="gridWrap" className="gridWrap">
                    ...
                    >
                        <FlexGridColumn header="종이 공급처" binding="prdComp" width={100}/>
                        <FlexGridColumn header="평량(g/㎡)" binding="basisWeight" width={80} align="right"/>
                        <FlexGridColumn header="색상" binding="color" width={80}/>
                        <FlexGridColumn header="종이 종류" binding="paperType" width={100}/>
                        <FlexGridColumn header="종이 규격" binding="paperStandard" width={100}/>
                        <FlexGridColumn header="고시가격" binding="officialPrice" width={100} align="right"/>
                        <FlexGridColumn header="할인율" binding="dcRate" width="*" minWidth={100} align="right"/>
                        <FlexGridColumn header="단가" binding="price" width={100} align="right"/>
                        <FlexGridColumn header="할인율 적용일" binding="rate_at" width={120}/>

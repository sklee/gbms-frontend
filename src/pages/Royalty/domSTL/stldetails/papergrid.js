...
const PaperGrid = observer(( props ) =>{
    ...
    const initFilter = (filter) => {
        filter.filterColumns = ["copyrighter", "department", "prdCode", "prdName", "listPrice", "salesUpTo", "generalSales", "specialSales", "totalSales", "currentSales", "e1", "e2", "e3", "e4", "e5", "e6", "e7", "e8", "e9","e11","e12","e13","e14","e15","e16","e17","e18","e19","e20","exception"];
    };
    ...
    return(
        <>
            ...
            >
                ...
                <FlexGridColumn binding="e1" header="정산 비율\n(일반1)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e2" header="판매량\n(일반1)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e3" header="발생 정기\n저작권료(일반1)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e4" header="정산 비율\n(일반#)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e5" header="판매량\n(일반#)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e6" header="발생 정기\n저작권료(일반#)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e7" header="정산 비율\n(특판)" width={100} align="right" aggregate="Sum"/>
                ...
                <FlexGridColumn binding="e10" header="초판\n저작권료" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e11" header="선불+초판\n저작권료" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e12" header="전기까지 지급\n정기 저작권료" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e13" header="전기까지 지급\n전체 저작권료" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e14" header="전기 미지급\n저작권료" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e15" header="발생 정기\n저작권료(일반)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e16" header="발생 정기\n저작권료(특판)" width={100} align="right" aggregate="Sum"/>
                <FlexGridColumn binding="e17" header="발생 정기\n저작권료(합계)" width={100} align="right" aggregate="Sum"/>

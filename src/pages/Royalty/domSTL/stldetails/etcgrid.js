...
const EtcGrid = observer(( props ) =>{
    ...
    const initFilter = (filter) => {
        filter.filterColumns = ["copyrighter", "department", "prdCode", "prdName","prdSort", "salesUpTo", "totalSales", "currentSales", "salesRevenue", "publisherPayout", "settlRatio", "e8", "e9","e12","e13","e14","e17","e18","e19","e20","exception"];
    };
    ...
    return(
        <>
            ...
            >
                ...
                <FlexGridColumn binding="prdSort" header="상품종류" width={120} />
